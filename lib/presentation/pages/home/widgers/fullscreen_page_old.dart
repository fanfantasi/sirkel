...
// class FullscreenPageOld extends StatefulWidget {
//   const FullscreenPageOld({super.key});

//   @override
//   State<FullscreenPageOld> createState() => _FullscreenPageOldState();
// }

// class _FullscreenPageOldState extends State<FullscreenPageOld>
...
//                 '${Configs.baseUrlAudio}${datas[seletedIndex ?? 0].music?.file ?? ''}';
...
//                   final String soundPath =
//                       '${Configs.baseUrlAudio}${datas[value].music?.file ?? ''}';
//                   await MyAudioService.instance.play(
//                     path: soundPath,
//                     mute: false,
//                     startedPlaying: () {
...
//               },
//               child: isVideo 
//               ? VideoPlayerWidget(datas: datas, index: index, isFullScreen: true, play: true, resumed: true,)
//               : SizedBox(
//                 width: double.infinity,
//                 height: double.maxFinite,
//                 child: AspectRatio(
//                   aspectRatio: Configs().aspectRatio(datas[index].pic!.first.width??0, datas[index].pic!.first.height??0),
//                   child: PageView.builder(
...
//                         imageUrl:
//                             '${Configs.baseUrlPic}/${datas[index].pic?[i].file}?tn=520',
//                         fit: BoxFit.cover,
//                         memCacheHeight:

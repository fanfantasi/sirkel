...
//         Uri.parse('${Configs.baseUrlVid}/${widget.data.pic!.first.file ?? ''}'));
...
//     return 
//chewieController != null && chewieController!.videoPlayerController.value.isInitialized && isInitialVideo
//           ? AspectRatio(
...
//                   imageUrl: '${Configs.baseUrlVid}/${widget.data.pic!.first.thumbnail ?? ''}',
//                   fit: BoxFit.cover,

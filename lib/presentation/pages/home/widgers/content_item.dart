...
class _ContentItemWidgetState extends State<ContentItemWidget> with WidgetsBindingObserver {
  ...
  Future<void> playMusic (ResultPictureEntity data, int index) async {
    print(data.startPosition);
    Future.delayed(const Duration(milliseconds: 600), () async {
      final String soundPath =
          '${Config.baseUrlAudio}${data.music?.file ?? ''}';
      await MyAudioService.instance.play(
        path: soundPath,
        mute: data.music!.mute,
        ...
        (index) {
          return VisibilityDetector(
            ...
            onVisibilityChanged: (visibilityInfo) async {
              ...
              debugPrint('Utilitas.scrolling ${Utilitas.scrolling.hasScroll()}');
              debugPrint('Utilitas.scrolling ${Utilitas.scrolling}');
              debugPrint('Utilitas.scrolling $visiblePercentage');
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      if (datas[index].music != null) soundMusic(datas[index], index),
  ...
  Widget soundMusic(ResultPictureEntity data, int index) {
    return Positioned(
        bottom: 20,
        right: 15,
        child: GestureDetector(
          onTap: () async {
            ...
            if (playIndex == index){
              await MyAudioService.instance.mute(data.music?.mute??false);
            }else{
              playMusic(datas[index], index);
            }

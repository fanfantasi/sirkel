...
import 'package:screenshare/core/widgets/navigatorview.dart';
...
class _NavigationPageState extends State<NavigationPage> {
  ...
  final tabs = [
    const NavigatorView(child: HomePage(),),
    const NavigatorView(child: CirclePage(),),
    const NavigatorView(child: CameraPage(),),
    const NavigatorView(child: SearchPage(),),
    const NavigatorView(child: ProfilePage(),),
  ];
  ...
  void _scrollTop() async {
    await Configs.scrollControllerHome.animateTo(0, duration: const Duration(milliseconds: 300),
    curve: Curves.easeIn);
